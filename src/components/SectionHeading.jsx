...
export default function SectionHeading({
  ...
  return (
    <div className={`mb-12 md:mb-16 ${isCenter ? 'text-center max-w-3xl mx-auto' : 'text-left max-w-2xl'} ${className}`}>
      {badge && (
        <div className={`inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-black uppercase tracking-widest bg-orange-950/60 text-orange-400 border border-orange-500/30 mb-4 shadow-sm ${isCenter ? 'mx-auto' : ''}`}>
