...
export default function Classes() {
  ...
  return (
    <div className="pt-24 bg-white text-slate-900">
      {/* Header */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 bg-slate-950 text-center overflow-hidden border-b border-slate-900">
        <div className="relative z-10 max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-black uppercase tracking-widest bg-yellow-400/20 text-yellow-300 border border-yellow-400/40 mb-4 backdrop-blur-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {scheduleTimetable.map((slot, idx) => {
            ...
            return (
              <div
                key={idx}
                className="bg-white rounded-3xl p-6 sm:p-7 border border-slate-200 hover:border-yellow-400 transition-all flex flex-col justify-between shadow-md hover:shadow-xl"
              >
                <div>
                  <div className="flex items-center justify-between gap-2 mb-4">
                    ...
                    <span className="px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider bg-yellow-50 text-yellow-800 border border-yellow-200">
                      {classInfo.category}
                    </span>
                  </div>

                  <h3 className="text-xl sm:text-2xl font-black text-slate-900 uppercase font-heading mb-2">
                    {classInfo.name}
                  </h3>
